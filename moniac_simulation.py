...
l = st.sidebar.slider('Production Multiplier (l)', min_value=0.1, max_value=2.0, value=0.8, step=0.1)
m = st.sidebar.slider('Consumption Multiplier (m)', min_value=0.1, max_value=2.0, value=0.5, step=0.1)
delta_v = st.sidebar.number_input('Change in Consumption (Δv)', min_value=-50, max_value=50, value=10, step=1)
